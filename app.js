...
var controller = (function(budgetCtrler, UICtrler) {
    var setupEventListeners = function() {
        var DOMStrings = UICtrler.getDOMStrings();
        ...
        document
            ...
            .addEventListener('change', UICtrler.changedType);
    };

    var updateBudget = function() {
        // 1. Calculate the budget
        budgetCtrler.calculateBudget();
    ...
    var updatePercentages = function() {
        ...
        budgetCtrler.calculatePercentages();

        // 2. Read percentages from the budget controller
        var percentages = budgetCtrler.getPercentages();

        // 3. Update the UI with the new percentages
        UICtrler.displayPercentages(percentages);
    };
